...
Awkfloat *FILENUM;	/* current file number 26Sep2022 */
...
void syminit(void)	/* initialize symbol table with builtin vars */
{
	...
	filenumloc = setsymtab("FILENUM", "", 0.0, NUM, symtab); /* 26Sep2022 count files */
	FILENUM = &filenumloc->fval;
